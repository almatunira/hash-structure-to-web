...
<html lang="en">
    ...
    <body>
        ...
        <center>
            <p>
                HOLA!<br>
               Nama      : Sitty Almatunira<br> 
               Panggilan : Al<br>
               TTL       : 29 Nov 2000<br>
               Status    : Mahasiswa<br>
               Jurusan   : S1 Informatika Universitas Syiah Kuala<br>
               Cita-cita : Menjadi Orang Kaya<br>
               Motto     : Banyak uang mah bebaaasss<br>
               Hobby     : Berenang
               <br>
            </p>
            <img src="assets\\img\\SittyAlmatunira.png" width="50%">
            </center>
        </div>
